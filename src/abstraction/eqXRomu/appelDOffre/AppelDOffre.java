...
public class AppelDOffre {
	 ...
	 */
	public AppelDOffre(IAcheteurAO acheteur, IProduit produit, double quantiteT, boolean TG) {
		if (acheteur==null) {
	...
	/**
	 * Par defaut, la mise en tete de gondole est fixee a false
	 * @param acheteur
	 * @param produit
	 * @param quantiteT
	 */
	public AppelDOffre(IAcheteurAO acheteur, IProduit produit, double quantiteT) {
		this(acheteur, produit, quantiteT,false);
	}
