...
public class MiseAuxEncheres {
	 ...
	 */
	public MiseAuxEncheres(IVendeurAuxEncheres vendeur, IProduit produit, double quantiteT, boolean TG) {
		if (vendeur==null) {
	...
	/**
	 * Sans precision la mise en tete de gondole est a false
	 * @param vendeur
	 * @param produit
	 * @param quantiteT
	 */
	public MiseAuxEncheres(IVendeurAuxEncheres vendeur, IProduit produit, double quantiteT) {
		this(vendeur, produit, quantiteT,false);
	}
	...
	public boolean equals(Object o) {
		return (o instanceof MiseAuxEncheres) 
				...
				&& this.getTeteGondole()==((MiseAuxEncheres)o).getTeteGondole();
	}
	
	public String toString() {
		return "("+Journal.doubleSur(this.getQuantiteT(), 3)
		+" de "+this.getProduit()+")";
	}
}
