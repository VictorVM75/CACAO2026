...
public class FiliereTestEncheres  extends Filiere {
	...
	public FiliereTestEncheres(long seed) {
		...
		this.ajouterActeur(new ExempleVendeurAuxEncheres(Chocolat.C_HQ_E, "valrona", 30000,12000.0));
		this.ajouterActeur(new ExempleVendeurAuxEncheres(Chocolat.C_HQ_E, "jeff", 30000,10000.0));
		this.ajouterActeur(new ExempleVendeurAuxEncheres(Chocolat.C_HQ_E, "leonidas", 30000,11000.0));
